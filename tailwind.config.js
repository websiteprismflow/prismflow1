    ...
    extend: {
      ...
      colors: {
        ...
        glass: {
          ...
          'border-mint': 'rgba(0, 119, 182, 0.35)',
      ...
      backgroundImage: {
        ...
        'prism-glow': 'radial-gradient(circle at 50% 30%, rgba(0, 119, 182, 0.12) 0%, rgba(15, 143, 156, 0.06) 50%, transparent 80%)',
      ...
      boxShadow: {
        ...
        'mint-glow': '0 0 30px -5px rgba(0, 119, 182, 0.35)',
        'robot-glow': '0 0 50px rgba(24, 184, 196, 0.25), 0 0 20px rgba(0, 119, 182, 0.3)',
      },
      animation: {
